...
namespace sensors {
     ...
     */
    //% blockId="OLED12864_I2C_PIXEL" block="画点|位置在 x %x|y %y|颜色 %color"
     ...
     */
    //% blockId="OLED12864_I2C_SHOWSTRING" block="显示文本|位置在 x %x|y %y|文本 %s|颜色 %color"
     ...
     */
    //% blockId="OLED12864_I2C_NUMBER" block="显示数字|位置在 x %x|y %y|数字 %num|颜色 %color"
    //% weight=80 blockGap=8
    //% parts=OLED12864_I2C trackArgs=0
     ...
     */
    //% blockId="OLED12864_I2C_HLINE" block="画竖线|位置在 x %x|y %y|长度 %len|颜色 %color"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_VLINE" block="画横线|位置在 x %x|y %y|长度 %len|颜色 %color"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_RECT" block="画矩形|位置在 x1 %x1|y1 %y1|x2 %x2|y2 %y2|颜色 %color"
     ...
     */
    //% blockId="OLED12864_I2C_INVERT" block="颠倒显示 %d"
     ...
     * draw / redraw screen
     */
    //% blockId="OLED12864_I2C_DRAW" block="更新显示"
     ...
     * turn on screen
     */
    //% blockId="OLED12864_I2C_ON" block="OLED开启"
     ...
     * turn off screen
     */
    //% blockId="OLED12864_I2C_OFF" block="OLED关闭"
     ...
     */
    //% blockId="OLED12864_I2C_init" block="OLED初始化地址： %addr"
